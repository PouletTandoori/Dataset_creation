...
class GeoDataset:
    ...
    def generate_dataset(self, nproc=1):
        ...
        n_samples= self.model.num_layers_max*(self.trainsize+self.validatesize+self.testsize)
        ...
        # transform Halton sequence into dictionary, each colomn is a key:
        Halton_seq = {keys[i]: Halton_seq[:, i] for i in range(len(keys))}
        ...
        print(f'Nb_layers: {samples["Nb_layers"].shape}\n,'
              ...
              f' litho: {samples["litho"].shape}\n,'
              f' Vp: {samples["Vp"].shape}\n,'
              f' Vs: {samples["Vs"].shape}\n,'
              f' Q: {samples["Q"].shape}')
        print('#############################################')
        ...
        #print('Halton seq at the end of validation dataset generation:')
        #print(f'Nb_layers: {samples["Nb_layers"].shape}\n,'
        #      f' thickness: {samples["thickness"].shape}\n,'
        #      f' litho: {samples["litho"].shape}\n,'
        #      f' Vp: {samples["Vp"].shape}\n,'
        ...
        #print('Halton seq at the end of testing dataset generation:')
        #print(f'Nb_layers: {samples["Nb_layers"].shape}\n,'
        #      f' thickness: {samples["thickness"].shape}\n,'
        #      f' litho: {samples["litho"].shape}\n,'
        #      f' Vp: {samples["Vp"].shape}\n,'
